<template>
  <el-container>
          ...
          <el-form label-position="left" :label-width="'120px'" size="mini">
            ...
            <el-form-item label="显示名称：">
              <el-input type="text" v-model="entityProps.label" :readonly="true">
                <i class="el-icon-edit primary-color" slot="suffix" title="修改显示名称" @click="modifyEntityLabel"></i>
              </el-input>
            </el-form-item>
    ...
    <el-container>
      <el-header class="list-search-panel">
        ...
        <div class="search-panel-right">
          <el-input type="text" v-model="searchText" :clearable="true" @clear="clearTableSearch" class="v-middle"
                    @keyup.enter.native="searchTableData" size="small" placeholder="请输入关键词搜索">
      ...
      <el-dialog :title="'新建字段 / ' + curEditorType" :visible.sync="showNewFieldDialogFlag" v-if="showNewFieldDialogFlag"
      ...
      <el-dialog title="编辑实体属性" :visible.sync="showEntityPropsDialogFlag" v-if="showEntityPropsDialogFlag"
