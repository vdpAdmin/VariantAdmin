      ...
      <el-container>
        <el-header>
          <el-input size="small" placeholder="请选择引用实体" v-model="refEntityFullName" :readonly="true">
            <el-button slot="append" v-if="fieldState === 1" icon="el-icon-search" title="选择"
...
<!--            <hr style="border: 0;border-top: 1px solid rgb(220, 223, 230)" />-->
    ...
    <el-dialog ref="entityListDlg" title="选择引用实体" :visible.sync="showEntityListDialogFlag" v-if="showEntityListDialogFlag"
