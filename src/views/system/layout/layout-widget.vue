...
export default {
  props: ['layout'],
  name: 'LayoutWidget',
  components: { LayoutSection, LayoutSectionItem, draggable },
  data () {
    return {
...
<style lang="scss" scoped>
  ...
  ::v-deep .el-collapse-item__header, ::v-deep .el-collapse-item__header.is-active {
    cursor: default;
    height: 36px;
    line-height: 36px;
    font-size: 11px;
  ...
  ::v-deep .hide .el-collapse-item__header, .hide .el-collapse-item__header.is-active {
    cursor: default;
    display: none;
    height: 0;
    line-height: 0;
  ...
  .field-wrapper {
    ...
    ::v-deep .el-form-item, ::v-deep .el-form-item__label {
      font-size: 12px;
      overflow: hidden;
